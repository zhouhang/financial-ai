...
async def list_digital_employees(
    ...
    try:
        # 导入 MCP 客户端函数
        from app.tools.mcp_client import list_digital_employees as mcp_list_digital_employees
...
async def list_rules_by_employee(
    ...
    try:
        # 导入 MCP 客户端函数
        from app.tools.mcp_client import list_rules_by_employee as mcp_list_rules_by_employee
