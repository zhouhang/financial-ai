...
BROWSER_COLLECTION_ALERT_POLL_SECONDS: float = float(os.getenv("BROWSER_COLLECTION_ALERT_POLL_SECONDS", "60"))
BROWSER_COLLECTION_ALERT_AGENT_GRACE_MINUTES: int = int(os.getenv("BROWSER_COLLECTION_ALERT_AGENT_GRACE_MINUTES", "5"))
BROWSER_COLLECTION_ALERT_MISSED_SUCCESS_HOURS: int = int(os.getenv("BROWSER_COLLECTION_ALERT_MISSED_SUCCESS_HOURS", "30"))
