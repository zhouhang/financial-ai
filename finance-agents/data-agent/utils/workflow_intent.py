...
from models import UserIntent, ReconciliationPhase
...
async def handle_intent_switch_guest(
    ...
    if intent == "LOGIN":
        ...
        from graphs.main_graph.forms import generate_login_form
        return {
        ...
        from graphs.reconciliation.nodes import _generate_friendly_response_for_other_intent
