...
from api.schemas.schema import SchemaCreate, SchemaUpdate
from api.utils.pinyin import generate_type_key
...
class SchemaService:
    ...
    def validate_schema_content(schema_content: dict) -> dict:
        ...
        from api.schemas.schema import SchemaContentValidateResponse
    ...
    async def test_schema_execution(schema_content: dict, file_paths: list) -> dict:
        ...
        """
        import time
        from api.schemas.schema import SchemaTestResponse
