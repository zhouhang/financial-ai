...
43. **043_recon_digest_subscription_natural_key.sql** - 对账日报订阅自然键幂等约束
44. **044_recon_diff_digestion_fields.sql** - 对账差异消化审计字段
45. **045_remove_recon_digest_net_deduction_display.sql** - 暂停展示日报综合扣减指标
46. **046_disable_platform_oauth_auto_collection.sql** - 清理平台授权数据集自动采集调度配置，仅保留手动采集
...
- 当前最新增量迁移：`046_disable_platform_oauth_auto_collection.sql`。
