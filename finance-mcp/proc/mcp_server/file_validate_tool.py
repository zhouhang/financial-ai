...
# 导入文件校验规则查询函数（含缓存）
from proc.mcp_server.tools import _get_file_validation_rule
...
async def _handle_validate_uploaded_files(arguments: dict) -> dict:
    ...
    try:
        rule_record = _get_file_validation_rule(rule_code)
    ...
    # rule_record["rule"] 已在 _get_file_validation_rule 中解析为 dict
